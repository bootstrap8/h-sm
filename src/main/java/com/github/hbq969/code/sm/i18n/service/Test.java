package com.github.hbq969.code.sm.i18n.service;
...
public class Test {
    public static void main(String[] args) throws Exception {
        ...
        List<Map<String,Object>> list=jt.queryForList("select pair_key AS \"key\",pair_value AS \"value\" from h_dict_pairs where dict_name='lang,ja-JP'");
